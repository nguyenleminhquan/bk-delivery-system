...
function AssignOrderToVehicle({ order_id='', handleClose=null, showTitle=true }) {
    ...
    return (
        <div className='assign-order-to-vehicle'>
            <div className='form-wrapper'>
                {
                    showTitle && <h5 className='title'>Gán đơn hàng cho tài xế vận chuyển</h5>
                }
...
export default AssignOrderToVehicle